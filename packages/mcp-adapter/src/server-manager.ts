...
import { type AuthStorageOptions, invalidateAuthEntryCache } from "./mcp-auth.ts";
...
export class McpServerManager {
	...
	private pendingMetadataPublications = new Map<string, { connection: ServerConnection; reason: string }>();
	...
	private async createConnection(
		...
		if (tracingEnabled && !this.traceWriter) {
